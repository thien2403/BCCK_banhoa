  ...
  return (
    <SafeAreaView style={{backgroundColor: '#FFF', height: '100%', flex: 1}}>
      ...
      <View
        ...
        <Icon name="mail" color="#67D1A6" size={24} />
        <TextInput
          placeholder="Email"
          placeholderTextColor="#67D1A6"
      ...
      <View
        ...
        <Icon name="md-lock-closed" color="#67D1A6" size={28} />
        <TextInput
        ...
        <TouchableOpacity onPress={updateSecureTextEntry}>
          {data.secureTextEntry ? (
            <Feather name="eye-off" color="#67D1A6" size={22} />
          ) : (
            <Feather name="eye" color="#67D1A6" size={22} />
          )}
        </TouchableOpacity>
      </View>
      <View
